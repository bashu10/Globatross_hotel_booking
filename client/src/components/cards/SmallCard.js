        ...
        <div className="row no-gutters">
            <div className="col-md-4">
                {h.image && h.image.contentType ? (
                    ...
                    className="cerd-image img img-fluid"
                    />
                ):(
                    <img 
                    src="https://via.placeholder.com/900x500.png?text=Globatross" 
                    alt="default hotel image"
                    className="cerd-image img img-fluid"
                    />
                )}
            ...
            <div className="col-md-8">
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between h4">
                        {showViewMoreButton && <button onClick={() => history.push(`/hotel/${h._id}`)} className="btn btn-primary">
                            Show more 
                        </button>}
                        {
                            owner && (
                            <>
                                ...
                                <DeleteOutlined 
                                onClick={() => handleHotelDelete(h._id)} className="text-danger"
                                />
                            </>
                            )
                        }
