...
// import { searchListings } from '../client/src/actions/hotel';
...
export const create = async(req, res)=>{
    ...
    try{
        ...
        hotel.save((err, result)=>{
            if(err){
                console.log("err in saving hotel==>",err);
...
export const remove= async(req,res)=>{
    let remove= await Hotel.findByIdAndDelete(req.params.hotelId).select("-image.data").exec();
    res.json(remove);
};
